...
export const Tut46 = () => {
  ...
  // ✅ Added state to keep track of steps
  const [steps, setSteps] = useState(1); // default step is 1

  // ✅ Function to update step from input field
  function handleInputChange(e) {
    const newStep = Number(e.target.value); // ✅ Convert string to number
    setSteps(newStep);
  }
